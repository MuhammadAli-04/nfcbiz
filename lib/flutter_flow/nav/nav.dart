...
import 'package:nfc_biz/screens/create_ticket_screen/create_ticket_screen_widget.dart';
import 'package:nfc_biz/screens/display_nfc_link_screen/display_nfc_link_screen_widget.dart';
import 'package:nfc_biz/screens/display_nfc_links_list_screen/display_nfc_links_list_screen_widget.dart';
import 'package:nfc_biz/screens/display_ticket_details_screen/tickets_details_widget.dart';
import 'package:nfc_biz/screens/display_tickets_screen/tickets_screen_widget.dart';
import 'package:nfc_biz/screens/create_nfc_link_screen/nfc_link_screen_widget.dart';
...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          name: 'plans_screen',
          path: '/plansScreen',
          builder: (context, params) => const PlansScreenWidget(),
        ),
        FFRoute(
          name: 'paymemt_request_Screen',
          path: '/paymemtRequestScreen',
          builder: (context, params) => const PaymemtRequestScreenWidget(),
        ),
        FFRoute(
          name: 'payment_screen',
          path: '/paymentScreen',
        ...
        FFRoute(
          name: 'tickets_screen',
          path: '/ticketsScreen',
          builder: (context, params) => const TicketsScreenWidget(),
        ),
        FFRoute(
          name: 'nfc_link_screen',
          path: '/nfcLinkScreen',
          builder: (context, params) => const DisplayNFCLinkScreenWidget(),
        ),
        FFRoute(
          name: 'create_nfc_link_screen',
          path: '/createNfcLinkScreen',
          builder: (context, params) => NFCLinkScreenWidget(
            category: params.getParam("category", ParamType.String),
            url: params.getParam("url", ParamType.String),
          ),
        ),
        FFRoute(
          name: 'display_nfc_links_list_screen',
          path: '/createNfcLinksListScreen',
          builder: (context, params) => DisplayNFCLinksListScreenWidget(
              category: params.getParam("category", ParamType.String)),
        ),
        FFRoute(
          name: 'ticket_details_screen',
          path: '/ticketDetailsScreen',
          builder: (context, params) => TicketDetailsWidget(
            ticketID: params.getParam("ticketId", ParamType.int),
            customerName: params.getParam("customerName", ParamType.String),
            categoryName: params.getParam("categoryName", ParamType.String),
          ),
        ),
        FFRoute(
          name: 'create_ticket_screen',
          path: '/createTicketScreen',
          builder: (context, params) => const CreateTicketScreenWidget(
              // ticketID: params.getParam("ticketId", ParamType.int),
              // customerName: params.getParam("customerName", ParamType.String),
              // categoryName: params.getParam("categoryName", ParamType.String),
              ),
